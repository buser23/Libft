...
/*   Updated: 2023/05/17 13:26:48 by bsalgado         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
    ...
    2 - It declares a local variable i of type size_t to keep track of the length 
	of the string.

    3 - The code enters a while loop that continues until it encounters the null 
	terminator ('\0') character, indicating the end of the string.
